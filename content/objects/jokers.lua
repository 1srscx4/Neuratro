...
return { vars = {G.playbook_extra and yes and (G.playbook_extra.config.card_limit - 2)  or 2,card.ability.extra.goal,card.ability.extra.goal - card.ability.extra.sold}}
end,
calculate = function (self, card, context)
